CREATE TABLE shortener_campaigns (
...
CREATE TABLE short_link_qrcodes (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE user_bio_profiles (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    user_id INTEGER NOT NULL,
...
CREATE TABLE bio_social_clicks (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    bio_id INTEGER NOT NULL,
...
CREATE TABLE user_product_listings (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  user_id INTEGER NOT NULL,
  bio_id INTEGER NOT NULL,
...
CREATE TABLE bio_custom_domains (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  bio_id INTEGER NOT NULL,
  user_id INTEGER NOT NULL,
...
CREATE TABLE user_promo_banners (user_id INTEGER PRIMARY KEY, template TEXT, style TEXT, status TEXT DEFAULT pending, error_text TEXT, created_at TEXT);
