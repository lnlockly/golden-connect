 ...
 * Landing → bot webhook.
 *
 * The goldenConnect.website landing POSTs three kinds of form submissions
...
export interface LandingConfig {
  secret: string;                  // if set, required as x-goldenConnect-secret
  chatId: number | null;
...
export async function handleLandingWebhook(
  ...
  res.setHeader("access-control-allow-headers", "content-type, x-goldenConnect-secret");
  ...
  const secretHeader = req.headers["x-goldenConnect-secret"];
