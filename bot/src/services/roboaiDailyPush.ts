...
//
// Утренний пуш в @GoldenConnectCRMBot каждому пользователю с активной CRM-сессией:
...
const CRM_URL =
	process.env.CRM_WEBAPP_URL || "https://crm.goldenConnect.to/cabinet/crm-app.html"
