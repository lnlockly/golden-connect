...
const OVER_QUOTA_TEXT: Record<string, string> = {
  ru: "Лимит диалога на сегодня исчерпан. Оператор подхватит разговор лично — напиши @goldenConnect_founder или жми /start.",
  en: "Daily chat limit reached. Reach out to @mlm808 or tap /start to continue.",
  zh: "今日对话额度已用完。人工运营会接手 — 联系 @goldenConnect_founder 或点 /start。",
};
