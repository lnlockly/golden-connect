...
(function () {
  ...
  function loadCompanyLinkForButtons() {
    ...
    fetch('/cabinet/api/company-link' + (ref ? '?ref=' + ref : '')).then(function(r) { return r.json(); }).then(function(data) {
      var link = data.companyLink || 'https://goldenConnect.to/';
      // Replace all goldenConnect.to links (except /faq and /instructions) with company referral link
      document.querySelectorAll('a[href*="goldenConnect.to"]').forEach(function(a) {
