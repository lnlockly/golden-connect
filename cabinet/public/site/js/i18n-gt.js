...
// Piggybacks on GoldenConnectI18n (data-i18n dictionary for menu) and translates
...
(function () {
  ...
  function applyCurrent() {
    var lang = (window.GoldenConnectI18n && window.GoldenConnectI18n.getLang && window.GoldenConnectI18n.getLang()) || 'ru';
  ...
  if (window.GoldenConnectI18n && window.GoldenConnectI18n.onReady) {
    window.GoldenConnectI18n.onReady(bootstrap);
