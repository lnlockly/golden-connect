...
(function () {
  ...
  window.loadTrdxPage = async function () {
    ...
    [
      ...
      ['💰', 'Дивиденды каждый квартал', 'Каждые 3 месяца держателям TRDX начисляется в долларах процент от дохода Trendex. Чем больше TRDX — тем больше доля.'],
    ...
    html +=
      ...
      '<b style="color:#e0e7ff">Важно:</b> Genesis TRDX — это пресейл-токен Trendex. Биржа, дивиденды и розыгрыши запустятся после официального старта платформы. Сейчас идёт фаза накопления — баланс не списывается, только растёт. Условия начисления и утилиты могут уточняться до запуска.' +
      '</div>';
