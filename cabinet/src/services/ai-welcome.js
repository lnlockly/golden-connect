...
const SERVICES = [
  ...
  { id: 'banner_ad', label: 'Баннерная реклама на сайте', desc: 'твой баннер показывается на партнёрских страницах Trendex, оплата за реальные показы во внутренней валюте TRDX.' },
  ...
  { id: 'meet',      label: 'Trendex Meet',          desc: 'видеозвонки с командой и партнёрами в браузере — без установки Zoom или Skype.' },
  ...
  { id: 'autopost',  label: 'TG-автопостинг',        desc: 'подключаешь свои TG-каналы, Trendex автоматически публикует контент по расписанию для роста охвата.' },
...
function _staticFallback(name, picked) {
  ...
  lines.push('Trendex — это экосистема возможностей. Вот что у нас есть:');
...
async function generateWelcome({ name = 'друг', isMember = false, lang = 'ru' } = {}) {
  ...
  const sys = [
    'Ты — приветствующий ассистент Trendex. Пишешь короткое сочное приветствие новому участнику в Telegram (HTML).',
    '',
    'СТРОГИЕ ПРАВИЛА:',
