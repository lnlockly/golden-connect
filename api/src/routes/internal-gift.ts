...
const WORKING_MICRO_PER_USDT = 1_000_000n;  // Golden Connect cash_ledger scale (1e6)
...
// Пополнение GIFT Основной (тип 6) с Golden Connect working баланса 1:1, мгновенно.
