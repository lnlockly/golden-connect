...
export const env = {
  ...
  // Shared secret for /internal/* endpoints, sent as `x-goldenConnect-secret` by
  ...
  appPublicUrl: optional('APP_PUBLIC_URL', 'https://api.goldenConnect.to'),
  ...
  emailFrom: process.env.EMAIL_FROM ?? "Golden Connect <no-reply@goldenConnect.to>",
